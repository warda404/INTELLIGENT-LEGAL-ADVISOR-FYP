...
def api_compare_2():
    ...
    vec1 = thesis_model.infer_vector(data['doc1'].split(" "))
    vec2 = thesis_model.infer_vector(data['doc2'].split(" "))
...
def api_compare_all():
    ...
    vec = thesis_model.infer_vector(data['doc'].split(" "))
